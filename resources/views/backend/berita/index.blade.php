                                ...
                                @php $id += 1; @endphp
                                  ...
                                  <tr>
                                      ...
                                      <td><a data-toggle="modal" data-target="#update-modal-{{ $id }}" class="btn btn-outline-success updateData" data-id="'+index+'">Lihat</a>
                                        <a data-toggle="modal" data-target="#remove-modal-{{ $id }}" class="btn btn-outline-danger removeData" data-id="{{ $key }}">Hapus</a></td>
                                  </tr>
                                              ...
                                              <div class="modal-body" id="updateBody">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="category" class="col-md-12 col-form-label">Category</label>
                                                        <div class="col-md-12">
                                                            <input id="category" type="text" class="form-control" name="category" value="{{ $berita['category'] }}" disabled required autofocus>
                                                        </div>
                                                      </div>
                                                    <div class="form-group">
                                  ...
                                  <form action="{{ route('admin.berita.destroy')}}" method="DELETE" class="users-remove-record-model">
                                      <div id="remove-modal-{{ $id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
