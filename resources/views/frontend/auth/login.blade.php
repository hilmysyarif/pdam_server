...
<div class="col-md-8">
  ...
  <div class="card-group">
    <div class="card p-4">
      <div class="card-body">
        <h1>@lang('Masuk')</h1>
        <p class="text-muted">@lang('Silahkan masuk untuk melanjutkan')</p>
        ...
        @csrf
          ...
          <div class="input-group mb-4">
            ...
            <input id="password" class="form-control" type="password" placeholder="@lang('Password')" name="password"/></div>
          <div class="row">
            <div class="col-6"><button id="login" class="btn btn-success px-4" type="submit">@lang('Masuk')</button></div>
          </div>
        </form>
      </div>
    </div>
